...
# Mac
iconutil --convert icns --output $BASE_DIR/../file-overrides/dist-assets/icon.icns $BASE_DIR/icon.iconset
iconutil --convert icns --output $BASE_DIR/../file-overrides/dist-assets/dmg-icon.icns $BASE_DIR/dmg-icon.iconset
...
convert \
    ...
    $BASE_DIR/../file-overrides/dist-assets/icon.ico
...
convert \
    ...
    $BASE_DIR/../file-overrides/dist-assets/win-installer.ico

# Linux window icon
cp $BASE_DIR/icon.iconset/icon_512x512@2x.png $BASE_DIR/../file-overrides/src/static/img/icon.png

# Linux app icons
LINUX_DIR=$BASE_DIR/../file-overrides/dist-assets/linux-icon
mkdir $BASE_DIR/../file-overrides/dist-assets/linux-icon || true
...
# Some other icon
cp $BASE_DIR/icon.iconset/icon_512x512@2x.png $BASE_DIR/../file-overrides/dist-assets/icon.png
